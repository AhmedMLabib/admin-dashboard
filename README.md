...
* ✅ Responsive sidebar with toggle on mobile devices
* ✅ Navbar component
* ✅ Pre-built pages: Dashboard, Users, Records, Items, Create Item (static/demo content)
* ✅ Tables with horizontal scrolling on small screens
* ✅ Dark Mode support
* ✅ Primary color can be changed in demo (limited)
...
[Demo on GitHub Pages](https://ahmedmlabib.github.io/admin-dashboard/)
...
Developed by **Ahmed Mohamed Labib**
[GitHub](https://github.com/AhmedMLabib) | [Portfolio](https://ahmedmlabib.github.io/portfolio/)
